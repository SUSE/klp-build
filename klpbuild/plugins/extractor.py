...
class Extractor():
    ...
    def process(self, args):
        ...
        out_dir = cs.get_cpp_work_dir(self.lp_name, fname)
    ...
    def run(self):
        ...
        for cs in working_cs:
            ...
            shutil.rmtree(cs.get_cpp_dir(self.lp_name), ignore_errors=True)
    ...
    def get_work_lp_file(self, cs, fname):
        return Path(cs.get_cpp_work_dir(self.lp_name, fname), cs.lp_out_file(self.lp_name, fname))
