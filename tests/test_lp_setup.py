...
class LpSetupTest(utils.TestUtils):
    ...
    def test_missing_conf_archs(self):
        v = self.sargs()
        v["archs"] = []
        self.setup_and_assert(v, ValueError, "Please specify --conf when not all architectures are supported")

        # All archs supported, complain about file-funcs
        v["archs"] = ["x86_64", "ppc64le", "s390x"]
        self.setup_and_assert(v, ValueError, "You need to specify at least one of the file-funcs variants!")
    ...
    def test_missing_conf_mod(self):
        v = self.sargs()
        v["module"] = "tun"
        self.setup_and_assert(v, ValueError, "Please specify --conf when a module is specified")
    ...
    def test_non_existent_file(self):
        ...
        v["module"] = "tun"
        v["conf"] = "CONFIG_TUN"
        v["file_funcs"] = [["drivers/net/tuna.c", "tun_chr_ioctl", "tun_free_netdev"]]
    ...
    def test_invalid_sym(self):
        ...
        v["module"] = "tun"
        v["conf"] = "CONFIG_TUN"
        v["file_funcs"] = [["drivers/net/tun.c", "tun_chr_ioctll", "tun_free_netdev"]]

        self.setup_assert_logs(v, "WARNING", "Symbols tun_chr_ioctll not found on tun")
    ...
    def test_check_conf_mod_file_funcs(self):
        ...
        v["conf"] = "CONFIG_NET_SCH_QFQ"
        v["file_funcs"] = [["net/sched/sch_qfq.c", "qfq_change_class"]]
        v["mod_file_funcs"] = [["btsdio", "drivers/bluetooth/btsdio.c", "btsdio_probe", "btsdio_remove"]]
        ...
        v["conf_mod_file_funcs"] = [
            ["CONFIG_BT_HCIBTSDIO", "btsdio", "drivers/bluetooth/btsdio.c", "btsdio_probe", "btsdio_remove"]
        ]
