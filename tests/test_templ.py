...
class TemplTesting(utils.TestUtils):
    ...
    def test_templ_with_externalized_vars(self):
        ...
        self.output_contains_not(v, cs, ['LP_MODULE', 'module_notify',
    ...
    def test_check_header_file_included(self):
        ...
        self.output_contains_not(v, cs, ['Upstream commit:'],
                                 f'bsc{v["bsc"]}_kernel_events_core.c')
        self.output_contains_not(v, cs, ['Upstream commit:'],
                                 f'bsc{v["bsc"]}_fs_exec.c')
